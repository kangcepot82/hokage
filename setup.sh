...
sleep 2
clear
wget https://raw.githubusercontent.com/kangcepot82/hokage/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
### Pasang Rclone
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By HOKAGE LEGEND ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
rm /root/setup.sh >/dev/null 2>&1
